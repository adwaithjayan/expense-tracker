          ...
          <ScreenWrapper>
                <View style={styles.container}>
                      ...
                      <View style={styles.footer}>
                            ...
                            <Animated.View entering={FadeInDown.duration(1000).delay(200).springify().damping(12)} style={styles.bottomContainer}>
                                  <Button onPress={() => router.push("/(auth)/register")}>
                                        <Typo color={colors.neutral900} fontWeight={'600'} size={22}>Get Started</Typo>
                                  </Button>
                            </Animated.View>
                      </View>
                </View>
